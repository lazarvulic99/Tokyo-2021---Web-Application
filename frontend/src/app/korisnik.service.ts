...
export class KorisnikService {
  ...
  dohvatiSveNeodobreneKorisnike(){
    return this.http.get(`${this.uri}/korisnici/dohvatiSveNeodobreneKorisnike`);
  }
  ...
  napraviRekordZaDelegiranje(kor_ime, ime, prezime, broj, discipline){
    const podaci = {
      kor_ime: kor_ime,
      ime: ime,
      prezime: prezime,
    ...
    return this.http.post(`${this.uri}/korisnici/napraviRekordZaDelegiranje`, podaci);
  }
  ...
  povecajBrojDeligaranja(ime, prezime){
    const podaci = {
      ime: ime,
      prezime: prezime
    }
    return this.http.post(`${this.uri}/korisnici/povecajBrojDeligaranja`, podaci);
  }

  dodajDisciplinu(imeIPrezime, disciplina){
    const podaci = {
      imeIPrezime: imeIPrezime,
      disciplina: disciplina
    }
    return this.http.post(`${this.uri}/korisnici/dodajDisciplinu`, podaci);
  }

  postaviDisccipline(ime, prezime, disciplinaZaTakmicenje){
    const podaci = {
      ime: ime,
      prezime: prezime,
      disciplina: disciplinaZaTakmicenje
    }
    return this.http.post(`${this.uri}/korisnici/postaviDisccipline`, podaci);
  }
